  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="my-2 text-center text-secondary">Mengganti Role dapat merubah hak akses dari user, Klik Ganti Role untuk melanjukan perintah ini</p>
            <form action="{{ route('user.update-role') }}" method="POST">
                ...
                <div>
                    <button type="submit" class="btn btn-primary w-100 py-2">Ganti Role</button>
                </div>
            </form>
      </div>
    </div>
